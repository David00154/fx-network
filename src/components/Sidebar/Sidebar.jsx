...
import { CreativeTimLogo } from "../Icons/Icons.jsx";
import { Separator } from "../Separator/Separator.jsx";
import { SidebarHelp } from "../Sidebar/SidebarHelp.jsx";
  ...
  const createLinks = (routes) => {
    ...
    return routes.map((prop, key) => {
      ...
      return (
        ...
        <Link key={key} href={'/dashboard' + prop.path}>
...
export function SidebarResponsive(props) {
  ...
  const createLinks = (routes) => {
    ...
    return routes.map((prop, key) => {
      ...
      return (
        <Link href={'/dashboard' + prop.path} key={key}>
          {activeRoute(prop.path) === "active" ? (
            <>
              {prop.category == "account" ? (<></>) : (<Button
              boxSize="initial"
              justifyContent="flex-start"
              alignItems="center"
              bg={activeBg}
