...
const testimonials = [
  ...
  },
  {
    name: "Ronne Galle",
    role: "Movie star",
    content: `“ Within one week of joining fx network, I profited enough
  ...
  },
  {
    ...
    in the next 2months. Excited to see where fx network takes
    us next. ”`,
    avatar:
      ...
      >
        ...
        >
          ...
          >
            ...
            people use Fx Network to trade and make money
          </chakra.h2>
        </Box>
        <SimpleGrid
          columns={{ base: 1, xl: 2 }}
